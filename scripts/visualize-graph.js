...
// Load alias mapping and graph data from the output folder
const dbAliasMap = JSON.parse(fs.readFileSync(path.join(outputFolder, 'db-aliases.json'), 'utf-8'));
const graphData = JSON.parse(fs.readFileSync(path.join(outputFolder, 'graph-data-transformed.json'), 'utf-8'));
